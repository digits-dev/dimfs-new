...
class AdminSubClassification extends Model
{
    use HasFactory;
        ...
        if ($request->filled('search')) {
            ...
            $query->where(function ($query) use ($search) {
                foreach ($this->filterable as $field) {
                    ...
                    elseif ($field === 'admin_classifications_id')  {
                        $query->orWhereHas('getAdminClassification', function ($query) use ($search) {
    ...
    public function getAdminClassification() {
        return $this->belongsTo(AdminClassification::class, 'admin_classifications_id', 'id');
    }
}
