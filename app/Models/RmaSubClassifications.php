...
class RmaSubClassifications extends Model
{
    use HasFactory;

    protected $table = 'rma_sub_classifications';
    ...
    public function getRmaClassification() {
        return $this->belongsTo(RmaClassifications::class, 'rma_classifications_id', 'id');
    }
}
