...
class AdminClassification extends Model
{
    use HasFactory;
        ...
        if ($request->filled('search')) {
            ...
            $query->where(function ($query) use ($search) {
                foreach ($this->filterable as $field) {
                    ...
                    elseif ($field === 'admin_categories_id')  {
                        $query->orWhereHas('getAdminCategory', function ($query) use ($search) {
    ...
    public function getAdminCategory() {
        return $this->belongsTo(AdminCategory::class, 'admin_categories_id', 'id');
    }
}
