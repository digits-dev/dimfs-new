...
namespace App\Http\Controllers\MarginMatrices;
...
class MarginMatricesController extends Controller
{
    ...
    public function __construct() {
        $this->sortBy = request()->get('sortBy', 'margin_matrices.created_at');
        $this->sortDir = request()->get('sortDir', 'desc');
        $this->perPage = request()->get('perPage', 10);
    }

    public function getAllData(){
        $query = MarginMatrix::query()->with(['getCreatedBy', 'getUpdatedBy', 'getBrand', 'getVendorType']);
    ...
    public function getIndex()
    {
        ...
        $data = [];
        $data['tableName'] = 'margin_matrices';
        $data['page_title'] = 'Margin Matrix';
        $data['margin_matrices'] = self::getAllData()->paginate($this->perPage)->withQueryString();
        ...
        return Inertia::render("MarginMatrices/MarginMatrices", $data);
    }
    ...
    public function create(Request $request){
        ...
        try {
            ...
            CommonHelpers::LogSystemError('Margin Matrix', $e->getMessage());
    ...
    public function update(Request $request){
        ...
        try {
            ...
            $margin_matrix = MarginMatrix::find($request->id);
    ...
    public function export()
    {
        ...
        $filename = "Margin Matrix - " . date ('Y-m-d H:i:s');
