...
const previewData = {
    ...
    message: data.api_name ? data.api_name : 'Data' + ' retrieved successfully'
};
        ...
        <div>
            ...
            <div className='p-3 border-t flex justify-end'>
                ...
                >
                    ...
                    <p className='text-xs'>Save & Generate API</p>
                </Button>
            </div>
        </div>
        <Modalv2
...
export default ApiGeneratorCreate