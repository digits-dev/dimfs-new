    ...
    return (
        <>
            ...
            <ContentPanel>
                ...
                <TableContainer data={item_promo_types?.data}>
                    <Thead>
                        <Row>
                            <TableHeader
                                sortable={false}
                    ...
                    <Tbody data={item_promo_types?.data}>
                        {item_promo_types &&
                            item_promo_types?.data.map((item, index) => (
                                <Row key={item.id}>
                                    <RowData center>
                                        <RowAction
                                            type="button"
                ...
                <Pagination extendClass={theme} paginate={item_promo_types} />
            </ContentPanel>
            <Modal
                theme={theme}
                show={isModalOpen}
                ...
                title={
                    action == "Add"
                        ...
                        : "Item Promo Type Information"
                }
                width="xl"
                fontColor={textColorActive}
                btnIcon="fa fa-edit"
            >
                <ItemPromoTypesAction
                    onClose={handleModalClick}
                    action={action}
