  ...
  return (
    <form>
        <div onSubmit={handleFilterSubmit} className='flex flex-col space-y-2 md:space-y-2'>
            ...
            <InputComponent
                name="incoterms_code"
                value={filters.incoterms_code}
                placeholder="Enter Incoterms Code"
                onChange={(e) => handleFilter(e, "incoterms_code")}
            />
            <InputComponent
                name="incoterms_description"
                value={filters.incoterms_description}
                placeholder="Enter Incoterms Description"
                onChange={(e) => handleFilter(e, "incoterms_description")}
            />
        </div>
...
export default IncotermsFilter