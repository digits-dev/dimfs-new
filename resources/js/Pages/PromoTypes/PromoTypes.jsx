...
const PromoTypes = ({ tableName, promo_types, queryParams }) => {
            ...
            <ContentPanel>
                <TopPanel>
                    <div className="inline-flex gap-1">
                        ...
                        >
                            <i className="fa-solid fa-plus mr-1"></i> Add Promo
                            Type
                        </Button>
                    </div>
                    <div className="flex">
                ...
                <TableContainer data={promo_types?.data}>
                    <Thead>
                        <Row>
                            <TableHeader
                                sortable={false}
                    ...
                    <Tbody data={promo_types?.data}>
                        {promo_types &&
                            promo_types?.data.map((item, index) => (
                                <Row key={item.id}>
                                    <RowData center>
                                        <RowAction
                                            type="button"
                ...
                <Pagination extendClass={theme} paginate={promo_types} />
            </ContentPanel>
            <Modal
                theme={theme}
                show={isModalOpen}
