    ...
    <form>
        <div onSubmit={handleFilterSubmit} className='flex flex-col space-y-2 md:space-y-2'>
            ...
            <InputComponent
                ...
                value={filters.promo_type_column}
                placeholder="Enter Promo Type Column"
                onChange={(e) => handleFilter(e, "promo_type_column")}
            />
            <InputComponent
                name="promo_type_description"
                value={filters.promo_type_description}
                placeholder="Enter Promo Type Description"
                onChange={(e) => handleFilter(e, "promo_type_description")}
            />
        </div>
...
export default PromoTypesFilter