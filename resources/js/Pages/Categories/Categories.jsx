...
const Categories = ({tableName, categories, queryParams}) => {
    ...
    return (
        <>
            ...
            <TopPanel>
                ...
                <TableContainer data={categories?.data}>
                   <Thead>
                        <Row>
                            <TableHeader
                                sortable={false}
                ...
                <Pagination extendClass={theme} paginate={categories} />
            </ContentPanel>
            <Modal
                theme={theme}
                show={isModalOpen}
                onClose={handleModalClick}
                title={action == 'Add' ? "Add Category" : action == 'Update' ? 'Update Category' : 'Category Information'}
                width="xl"
                fontColor={textColorActive}
                btnIcon='fa fa-edit'
            >
                <CategoriesAction onClose={handleModalClick} action={action} updateData={updateData}/>
            </Modal>
