...
const GashaponItemMasterApprovals = ({
    page_title,
    gashapon_item_master_approvals,
    queryParams,
    table_headers,
}) => {
    ...
    const handleSelectAll = () => {
        if (isSelectAllChecked) {
            ...
            setData(
                "selectedIds",
                gashapon_item_master_approvals.data.map((item) => item.id)
            );
        }
    ...
    const handleRowSelection = (id) => {
        setData((prevData) => {
            ...
            if (
                ...
                gashapon_item_master_approvals.data.length
            ) {
    ...
    const handleBulkAction = () => {
        ...
        post("gashapon_item_master_approvals/bulk_action", {
            onSuccess: (data) => {
    ...
    const handleExport = () => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                try {
                    window.location.href = `/gashapon_item_master_approvals/export`;
                } catch (error) {
                    {
                        handleToast &&
                            handleToast(
            ...
            <ContentPanel>
                {table_headers.length != 0 ? (
                    <>
                        ...
                        <TableContainer
                            data={gashapon_item_master_approvals?.data}
                        >
                            <Thead>
                                <Row>
                                    <TableHeader
                            ...
                            <Tbody data={gashapon_item_master_approvals?.data}>
                                {gashapon_item_master_approvals?.data?.map(
                                    (item, index) => (
                                        <Row key={index}>
                                            ...
                                            <RowData center>
                                                {item.status ===
                                                    ...
                                                    <RowAction
                                                        ...
                                                        onClick={() =>
                                                            router.get(
                                                                `/gashapon_item_master_approvals/approval_view/approval/${item.id}`
                                                            )
                                                        }
                                                    />
                                                )}
                                                ...
                                                <RowAction
                                                    ...
                                                    onClick={() =>
                                                        router.get(
                                                            `/gashapon_item_master_approvals/approval_view/view/${item.id}`
                                                        )
                                                    }
                                                />
                                            </RowData>
                        ...
                        <Pagination
                            extendClass={theme}
                            paginate={gashapon_item_master_approvals}
                        />
                    </>
                ) : (
...
export default GashaponItemMasterApprovals;
