        ...
        <>
            ...
            <TopPanel>
                    <div className="inline-flex gap-1">
                        ...
                        > 
                          <i className="fa-solid fa-plus mr-1"></i>  Add Color
                        </Button>
                    </div>
                    <div className='flex'>
                ...
                <TableContainer data={colors?.data}>
                   <Thead>
                        <Row>
                            <TableHeader
                                sortable={false}
                ...
                <Pagination extendClass={theme} paginate={colors} />
            </ContentPanel>
            <Modal
                theme={theme}
                show={isModalOpen}
                onClose={handleModalClick}
                title={action == 'Add' ? "Add Color" : action == 'Update' ? 'Update Color' : 'Color Information'}
                width="xl"
                fontColor={textColorActive}
                btnIcon='fa fa-edit'
            >
                <ColorsAction onClose={handleModalClick} action={action} updateData={updateData}/>
            </Modal>
