    ...
    const handleExport = (e) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                try {
                    window.location.href = '/rma_categories/export' + window.location.search;
                } catch (error) {
                    {
                        handleToast &&
                            handleToast(
        ...
        <>
            ...
            <TopPanel>
                    <div className="inline-flex gap-1">
                        ...
                        > 
                          <i className="fa-solid fa-plus mr-1"></i>  Add RMA Category
                        </Button>
                        <Button
                            extendClass={(['bg-skin-white'].includes(theme) ? primayActiveColor : theme)+" py-[5px] px-[10px]"}
                            type="button"
                ...
                <TableContainer data={rma_categories?.data}>
                   <Thead>
                        <Row>
                            <TableHeader
                                sortable={false}
                    ...
                    <Tbody data={rma_categories?.data}>
                        {rma_categories &&
                            rma_categories?.data.map((item, index) => (
                                <Row key={item.id}>
                                    <RowData center>
                                        <RowAction
                                            type="button"
                ...
                <Pagination extendClass={theme} paginate={rma_categories} />
            </ContentPanel>
            <Modal
                theme={theme}
                show={isModalOpen}
                onClose={handleModalClick}
                title={action == 'Add' ? "Add RMA Category" : action == 'Update' ? 'Update RMA Category' : 'RMA Category Information'}
                width="xl"
                fontColor={textColorActive}
                btnIcon='fa fa-edit'
            >
                <RmaCategoriesAction onClose={handleModalClick} action={action} updateData={updateData}/>
            </Modal>
