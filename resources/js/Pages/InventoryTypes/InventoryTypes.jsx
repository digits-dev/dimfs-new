...
const InventoryTypes = ({ tableName, inventory_types, queryParams }) => {
    ...
    return (
        <>
            ...
            <ContentPanel>
                ...
                <TableContainer data={inventory_types?.data}>
                    <Thead>
                        <Row>
                            <TableHeader
                                sortable={false}
                    ...
                    <Tbody data={inventory_types?.data}>
                        {inventory_types &&
                            inventory_types?.data.map((item, index) => (
                                <Row key={item.id}>
                                    <RowData center>
                                        <RowAction
                                            type="button"
                ...
                <Pagination extendClass={theme} paginate={inventory_types} />
            </ContentPanel>
            <Modal
                theme={theme}
                show={isModalOpen}
