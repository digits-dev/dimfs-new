...
const GashaponProductTypesFilter = () => {
    ...
    <form>
        <div onSubmit={handleFilterSubmit} className='flex flex-col space-y-2 md:space-y-2'>
            ...
            <InputComponent
                ...
                displayName="Gashapon Product Type Description"
                value={filters.product_type_description}
                placeholder="Enter Gashapon Product Type Description"
                onChange={(e) => handleFilter(e, "product_type_description")}
            />
        </div>
...
export default GashaponProductTypesFilter