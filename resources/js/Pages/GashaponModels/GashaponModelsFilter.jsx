    ...
    <form>
        <div onSubmit={handleFilterSubmit} className='flex flex-col space-y-2 md:space-y-2'>
            ...
            <InputComponent
                ...
                displayName="Gashapon Model Description"
                value={filters.model_description}
                placeholder="Enter Gashapon Model Description"
                onChange={(e) => handleFilter(e, "model_description")}
            />
        </div>
...
export default GashaponModelsFilter