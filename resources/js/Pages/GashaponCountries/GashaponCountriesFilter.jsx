  ...
  return (
    <form>
        <div onSubmit={handleFilterSubmit} className='flex flex-col space-y-2 md:space-y-2'>
            ...
            <InputComponent
                name="country_code"
                displayName="Gashapon Country Code"
                value={filters.country_code}
                placeholder="Enter Gashapon Country Code"
                onChange={(e) => handleFilter(e, "country_code")}
            />
            <InputComponent
                name="country_description"
                displayName="Gashapon Country Description"
                value={filters.country_description}
                placeholder="Enter Gashapon Country Description"
                onChange={(e) => handleFilter(e, "country_description")}
            />
        </div>
...
export default GashaponCountriesFilter