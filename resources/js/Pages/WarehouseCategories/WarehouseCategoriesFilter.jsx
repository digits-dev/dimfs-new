...
const WarehouseCategoriesFilter = () => {
    ...
    <form>
        <div onSubmit={handleFilterSubmit} className='flex flex-col space-y-2 md:space-y-2'>
            ...
            <InputComponent
                ...
                value={filters.warehouse_category_code}
                placeholder="Enter Warehouse Category Code"
                onChange={(e) => handleFilter(e, "warehouse_category_code")}
            />
            <InputComponent
                name="warehouse_category_description"
                value={filters.warehouse_category_description}
                placeholder="Enter Warehouse Category Description"
                onChange={(e) => handleFilter(e, "warehouse_category_description")}
            />
        </div>
...
export default WarehouseCategoriesFilter