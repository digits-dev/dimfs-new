    ...
    return (
        <>
            ...
            <ContentPanel>
                ...
                <TableContainer data={warehouse_categories?.data}>
                    <Thead>
                        <Row>
                            <TableHeader
                                sortable={false}
                    ...
                    <Tbody data={warehouse_categories?.data}>
                        {warehouse_categories &&
                            warehouse_categories?.data.map((item, index) => (
                                <Row key={item.id}>
                                    <RowData center>
                                        <RowAction
                                            type="button"
