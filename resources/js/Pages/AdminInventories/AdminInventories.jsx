    ...
    return (
        <>
            ...
            <ContentPanel>
                            ...
                            <Button
                                ...
                                onClick={() => {
                                    ...
                                    setUpdateData({
                                        ...
                                        inventory_description: "",
                                        brand_beacode: "",
                                        admin_inventories_id: "",
                                        status: "",
                                    });
                                }}
                            >
                                <i className="fa-solid fa-plus mr-1"></i> Add Inventory
                            </Button>
                        }
                        <Export path="/admin_inventories/export" page_title={page_title}/>
                    </div>
                    <div className="flex">
                        <CustomFilter>
                ...
                <TableContainer data={admin_inventories?.data}>
                    <Thead>
                        <Row>
                            <TableHeader
                                sortable={false}
                    ...
                    <Tbody data={admin_inventories?.data}>
                        {admin_inventories &&
                            admin_inventories?.data.map((item, index) => (
                                <Row key={item.id}>
                                    <RowData center>
                ...
                <Pagination extendClass={theme} paginate={admin_inventories} />
            </ContentPanel>
            <Modal
                theme={theme}
                show={isModalOpen}
