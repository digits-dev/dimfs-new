...
const GashaponInventoryTypesFilter = () => {
    ...
    <form>
        <div onSubmit={handleFilterSubmit} className='flex flex-col space-y-2 md:space-y-2'>
            ...
            <InputComponent
                ...
                displayName="Gashapon Inventory Type Description"
                value={filters.inventory_type_description}
                placeholder="Enter Gashapon Inventory Type Description"
                onChange={(e) => handleFilter(e, "inventory_type_description")}
            />
        </div>
...
export default GashaponInventoryTypesFilter