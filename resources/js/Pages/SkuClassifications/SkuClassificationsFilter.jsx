...
const SkuClassificationsFilter = () => {
    ...
    <form>
        <div onSubmit={handleFilterSubmit} className='flex flex-col space-y-2 md:space-y-2'>
            ...
            <InputComponent
                ...
                value={filters.sku_class_description}
                placeholder="Enter SKU Class Description"
                displayName="SKU Class Description"
                onChange={(e) => handleFilter(e, "sku_class_description")}
            />
        </div>
...
export default SkuClassificationsFilter