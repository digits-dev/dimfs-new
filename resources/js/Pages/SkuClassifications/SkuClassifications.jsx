    ...
    return (
        <>
            ...
            <ContentPanel>
                ...
                <TableContainer data={sku_classifications?.data}>
                    <Thead>
                        <Row>
                            <TableHeader
                                sortable={false}
                    ...
                    <Tbody data={sku_classifications?.data}>
                        {sku_classifications &&
                            sku_classifications?.data.map((item, index) => (
                                <Row key={item.id}>
                                    <RowData center>
                                        <RowAction
                                            type="button"
            ...
            <Modal
                ...
                title={
                    action == "Add"
                        ...
                        : "SKU Classification Information"
                }
                width="xl"
                fontColor={textColorActive}
                btnIcon="fa fa-edit"
            >
                <SkuClassificationsAction
                    onClose={handleModalClick}
                    action={action}
...
export default SkuClassifications;
