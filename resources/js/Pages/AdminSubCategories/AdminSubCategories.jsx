...
import AdminSubCategoriesAction from "./AdminSubCategoriesAction";

const AdminSubCategories = ({page_title, admin_sub_categories, queryParams, all_active_admin_categories, all_admin_categories}) => {
    ...
    return (
        <>
            ...
            <ContentPanel>
                <TopPanel>
                    <div className="inline-flex gap-1">
                        ...
                        {auth.access.isCreate &&
                            ...
                            >
                                <i className="fa-solid fa-plus mr-1"></i> Add Sub Category
                            </Button>
                        }
                        <Export path="/admin_sub_categories/export" page_title={page_title}/>
                    </div>
                    <div className="flex">
                        <CustomFilter>
                ...
                <TableContainer data={admin_sub_categories?.data}>
                    <Thead>
                        <Row>
                            <TableHeader
                                sortable={false}
                    ...
                    <Tbody data={admin_sub_categories?.data}>
                        {admin_sub_categories &&
                            admin_sub_categories?.data.map((item, index) => (
                                <Row key={item.id}>
                                    <RowData center>
                ...
                <Pagination extendClass={theme} paginate={admin_sub_categories} />
            </ContentPanel>
            <Modal
                theme={theme}
                show={isModalOpen}
