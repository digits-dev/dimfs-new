    ...
    <form>
        <div onSubmit={handleFilterSubmit} className='flex flex-col space-y-2 md:space-y-2'>
            ...
            <InputComponent
                ...
                onChange={(e) => handleFilter(e, "uom_code")}
            />
            <InputComponent
                name="uom_description"
                displayName="UOM Description"
                value={filters.uom_description}
                placeholder="Enter UOM Description"
                onChange={(e) => handleFilter(e, "uom_description")}
            />
        </div>
...
export default GashaponUomsFilter