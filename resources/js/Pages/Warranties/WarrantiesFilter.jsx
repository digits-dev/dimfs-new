  ...
  return (
    <form>
        <div onSubmit={handleFilterSubmit} className='flex flex-col space-y-2 md:space-y-2'>
            ...
            <InputComponent
                name="warranty_code"
                value={filters.warranty_code}
                placeholder="Enter Warranty Code"
                onChange={(e) => handleFilter(e, "warranty_code")}
            />
            <InputComponent
                name="warranty_description"
                value={filters.warranty_description}
                placeholder="Enter Warranty Description"
                onChange={(e) => handleFilter(e, "warranty_description")}
            />
        </div>
...
export default WarrantiesFilter