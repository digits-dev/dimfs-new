...
const ColorsAction = ({action, onClose, updateData, all_active_modules, all_modules, item_master_columns, gashapon_item_master_columns, database_tables_and_columns, rma_item_master_columns, item_master_accounting_columns}) => {
  ...
  return (
    <form onSubmit={handleFormSubmit} className='space-y-2'>
        ...
        <DropdownSelect
            ...
            name="column_name"
            options={data.module_name == 'Item Master' ?  item_master_columns : data.module_name == 'Gashapon Item Masters' ? gashapon_item_master_columns : data.module_name == 'RMA Item Master' ? rma_item_master_columns : item_master_accounting_columns}
