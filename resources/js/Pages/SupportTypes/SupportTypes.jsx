    ...
    return (
        <>
            ...
            <ContentPanel>
                ...
                <TableContainer data={support_types?.data}>
                    <Thead>
                        <Row>
                            <TableHeader
                                sortable={false}
                    ...
                    <Tbody data={support_types?.data}>
                        {support_types &&
                            support_types?.data.map((item, index) => (
                                <Row key={item.id}>
                                    <RowData center>
                                        <RowAction
                                            type="button"
                ...
                <Pagination extendClass={theme} paginate={support_types} />
            </ContentPanel>
            <Modal
                theme={theme}
                show={isModalOpen}
