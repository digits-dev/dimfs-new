    ...
    <form>
        <div onSubmit={handleFilterSubmit} className='flex flex-col space-y-2 md:space-y-2'>
            ...
            <InputComponent
                ...
                displayName="Apple LOB Description"
                value={filters.apple_lob_description}
                placeholder="Enter Apple LOB Description"
                onChange={(e) => handleFilter(e, "apple_lob_description")}
            />
        </div>
...
export default AppleLobsFilter