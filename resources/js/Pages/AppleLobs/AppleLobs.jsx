        ...
        <>
            ...
            <TopPanel>
                    <div className="inline-flex gap-1">
                        ...
                        > 
                          <i className="fa-solid fa-plus mr-1"></i>  Add Apple LOB
                        </Button>
                ...
                <TableContainer data={apple_lobs?.data}>
                   <Thead>
                        <Row>
                            <TableHeader
                                sortable={false}
                    ...
                    <Tbody data={apple_lobs?.data}>
                        {apple_lobs &&
                            apple_lobs?.data.map((item, index) => (
                                <Row key={item.id}>
                                    <RowData center>
                                        <RowAction
                                            type="button"
                                            ...
                                            onClick={()=>{handleModalClick(); setAction('Update'); 
                                                setUpdateData({
                                                    id: item.id,
                                                    apple_lob_description: item.apple_lob_description,
                                                    status: item.status,
                                                })
                ...
                <Pagination extendClass={theme} paginate={apple_lobs} />
            </ContentPanel>
            <Modal
                theme={theme}
                show={isModalOpen}
                onClose={handleModalClick}
                title={action == 'Add' ? "Add Apple LOB" : action == 'Update' ? 'Update Apple LOB' : 'Apple LOB Information'}
                width="xl"
                fontColor={textColorActive}
                btnIcon='fa fa-edit'
            >
                <AppleLobsAction onClose={handleModalClick} action={action} updateData={updateData}/>
            </Modal>
