    ...
    return (
        <>
            ...
            <ContentPanel>
                <TopPanel>
                    <div className="inline-flex gap-1">
                        ...
                        {auth.access.isCreate &&
                            ...
                            >
                                <i className="fa-solid fa-plus mr-1"></i> Add Currency
                            </Button>
                        }
                        <Export path="/admin_currencies/export" page_title={page_title}/>
                    </div>
                    <div className="flex">
                        <CustomFilter>
                ...
                <TableContainer data={admin_currencies?.data}>
                    <Thead>
                        <Row>
                            <TableHeader
                                sortable={false}
                    ...
                    <Tbody data={admin_currencies?.data}>
                        {admin_currencies &&
                            admin_currencies?.data.map((item, index) => (
                                <Row key={item.id}>
                                    <RowData center>
                ...
                <Pagination extendClass={theme} paginate={admin_currencies} />
            </ContentPanel>
            <Modal
                theme={theme}
                show={isModalOpen}
