    ...
    return (
        <>
            ...
            <ContentPanel>
                <TopPanel>
                    <div className="inline-flex gap-1">
                        ...
                        {auth.access.isCreate &&
                            ...
                            >
                                <i className="fa-solid fa-plus mr-1"></i> Add Incoterm
                            </Button>
                        }
                        <Export path="/admin_incoterms/export" page_title={page_title}/>
                    </div>
                    <div className="flex">
                        <CustomFilter>
                ...
                <TableContainer data={admin_incoterms?.data}>
                    <Thead>
                        <Row>
                            <TableHeader
                                sortable={false}
                    ...
                    <Tbody data={admin_incoterms?.data}>
                        {admin_incoterms &&
                            admin_incoterms?.data.map((item, index) => (
                                <Row key={item.id}>
                                    <RowData center>
                ...
                <Pagination extendClass={theme} paginate={admin_incoterms} />
            </ContentPanel>
            <Modal
                theme={theme}
                show={isModalOpen}
