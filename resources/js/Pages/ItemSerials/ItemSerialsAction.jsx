...
const ItemSerialsAction = ({ action, onClose, updateData }) => {
    ...
    const handleFormSubmit = (e) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                if (action == "Add") {
                    post("item_serials/create", {
                        onSuccess: (data) => {
                            const { message, type } = data.props.auth.sessions;
                            handleToast(message, type);
                            router.reload({ only: ["item_serials"] });
                            reset();
                            onClose();
                        },
                        onError: (error) => {},
...
export default ItemSerialsAction;
