...
const RmaItemMasterApprovals = ({
    page_title,
    tableName,
    rma_item_master_approvals,
    queryParams,
    table_headers,
}) => {
    ...
    const handleSelectAll = () => {
        if (isSelectAllChecked) {
            ...
            setData(
                "selectedIds",
                rma_item_master_approvals.data.map((item) => item.id)
            );
        }
    ...
    const handleRowSelection = (id) => {
        setData((prevData) => {
            ...
            if (
                ...
                rma_item_master_approvals.data.length
            ) {
    ...
    const handleBulkAction = () => {
        ...
        post("rma_item_master_approvals/bulk_action", {
            onSuccess: (data) => {
    ...
    const handleExport = () => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                try {
                    window.location.href = `/rma_item_master_approvals/export`;
                } catch (error) {
                    {
                        handleToast &&
                            handleToast(
            ...
            <ContentPanel>
                {table_headers.length != 0 ? (
                    <>
                        ...
                        <TableContainer data={rma_item_master_approvals?.data}>
                            <Thead>
                                <Row>
                                    <TableHeader
                                        name="id"
                            ...
                            <Tbody data={rma_item_master_approvals?.data}>
                                {rma_item_master_approvals?.data?.map(
                                    (item, index) => (
                                        <Row key={index}>
                                            ...
                                            <RowData center>
                                                {item.status ===
                                                    ...
                                                    <RowAction
                                                        ...
                                                        onClick={() =>
                                                            router.get(
                                                                `/rma_item_master_approvals/approval_view/approval/${item.id}`
                                                            )
                                                        }
                                                    />
                                                )}
                                                ...
                                                <RowAction
                                                    ...
                                                    onClick={() =>
                                                        router.get(
                                                            `/rma_item_master_approvals/approval_view/view/${item.id}`
                                                        )
                                                    }
                                                />
                                            </RowData>
                        ...
                        <Pagination
                            extendClass={theme}
                            paginate={rma_item_master_approvals}
                        />
                    </>
                ) : (
...
export default RmaItemMasterApprovals;
