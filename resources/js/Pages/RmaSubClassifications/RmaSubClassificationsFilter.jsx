...
const RmaSubClassificationsFilter = ({all_rma_classifications}) => {
    ...
    <form>
        <div onSubmit={handleFilterSubmit} className='flex flex-col space-y-2 md:space-y-2'>
            ...
            <DropdownSelect
                ...
                onChange={(e) => handleFilter(e, "rma_classifications_id", "select")}
                name="rma_classifications_name"
                displayName="RMA Classification Description"
                isStatus={true}
                options={all_rma_classifications}
            />
            <InputComponent
                name="sub_classification_description"
                value={filters.sub_classification_description}
                displayName="RMA Store Classification Description"
                placeholder="Enter RMA Store Classification Description"
                onChange={(e) => handleFilter(e, "sub_classification_description", "text")}
            />
        </div>
...
export default RmaSubClassificationsFilter