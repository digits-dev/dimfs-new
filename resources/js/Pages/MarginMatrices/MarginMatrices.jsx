...
import MarginMatricesAction from "./MarginMatricesAction";
import MarginMatricesFilter from "./MarginMatricesFilter";

const MarginMatrices = ({
    page_title,
    tableName,
    margin_matrices,
    queryParams,
            ...
            <ContentPanel>
                <TopPanel>
                    <div className="inline-flex gap-1">
                        ...
                        <Export path="/margin_matrices/export" page_title={page_title}/>
                    </div>
                    <div className="flex">
                        <CustomFilter>
                            <MarginMatricesFilter all_brands={all_brands} all_vendor_types={all_vendor_types}/>
                        </CustomFilter>
                        <TableSearch queryParams={queryParams} />
                    </div>
                </TopPanel>
                <TableContainer data={margin_matrices?.data}>
                    <Thead>
                        <Row>
                            <TableHeader
                                sortable={false}
                    ...
                    <Tbody data={margin_matrices?.data}>
                        {margin_matrices &&
                            margin_matrices?.data.map((item, index) => (
                                <Row key={item.id}>
                                    <RowData center>
                                        <RowAction
                                            type="button"
                ...
                <Pagination extendClass={theme} paginate={margin_matrices} />
            </ContentPanel>
            <Modal
                theme={theme}
                show={isModalOpen}
