...
const SkuStatusesAction = ({ action, onClose, updateData }) => {
    ...
    const { data, setData, processing, reset, post, errors } = useForm({
        id: "" || updateData.id,
        sku_status_code: "" || updateData.sku_status_code,
        sku_status_description: "" || updateData.sku_status_description,
    ...
    const handleFormSubmit = (e) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                if (action == "Add") {
                    post("sku_statuses/create", {
                        onSuccess: (data) => {
                            const { message, type } = data.props.auth.sessions;
                            handleToast(message, type);
                            router.reload({ only: ["sku_statuses"] });
                            reset();
                            onClose();
                        },
                        onError: (error) => {},
    ...
    return (
        <form onSubmit={handleFormSubmit} className="space-y-2">
            ...
            <InputComponent
                ...
                value={data.sku_status_description}
...
export default SkuStatusesAction;
