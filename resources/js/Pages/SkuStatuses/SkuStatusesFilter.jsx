    ...
    <form>
        <div onSubmit={handleFilterSubmit} className='flex flex-col space-y-2 md:space-y-2'>
            ...
            <InputComponent
                ...
                value={filters.sku_status_code}
                placeholder="Enter SKU Status Code"
                displayName="SKU Status Code"
                onChange={(e) => handleFilter(e, "sku_status_code")}
            />
            <InputComponent
                name="sku_status_description"
                value={filters.sku_status_description}
                placeholder="Enter SKU Status Description"
                displayName="SKU Status Description"
                onChange={(e) => handleFilter(e, "sku_status_description")}
            />
        </div>
...
export default SkuStatusesFilter