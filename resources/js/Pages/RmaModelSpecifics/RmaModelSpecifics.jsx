    ...
    return (
        <>
            ...
            <TopPanel>
                ...
                <TableContainer data={rma_model_specifics?.data}>
                   <Thead>
                        <Row>
                            <TableHeader
                                sortable={false}
                    ...
                    <Tbody data={rma_model_specifics?.data}>
                        {rma_model_specifics &&
                            rma_model_specifics?.data.map((item, index) => (
                                <Row key={item.id}>
                                    <RowData center>
                                        <RowAction
                                            type="button"
                ...
                <Pagination extendClass={theme} paginate={rma_model_specifics} />
            </ContentPanel>
            <Modal
                theme={theme}
                show={isModalOpen}
                onClose={handleModalClick}
                title={action == 'Add' ? "Add RMA Model Specific" : action == 'Update' ? 'Update RMA Model Specific' : 'RMA Model Specific Information'}
                width="xl"
                fontColor={textColorActive}
                btnIcon='fa fa-edit'
            >
                <RmaModelSpecificsAction onClose={handleModalClick} action={action} updateData={updateData}/>
            </Modal>
...
export default RmaModelSpecifics;
