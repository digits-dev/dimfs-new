    ...
    <form>
        <div onSubmit={handleFilterSubmit} className='flex flex-col space-y-2 md:space-y-2'>
            ...
            <InputComponent
                ...
                value={filters.model_specific_code}
                placeholder="Enter Model Specific Code"
                onChange={(e) => handleFilter(e, "model_specific_code")}
            />
            <InputComponent
                name="model_specific_description"
                value={filters.model_specific_description}
                placeholder="Enter Model Specific Description"
                onChange={(e) => handleFilter(e, "model_specific_description")}
            />
        </div>
...
export default RmaModelSpecificsFilter