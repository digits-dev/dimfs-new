...
const GashaponCategoriesFilter = () => {
    ...
    <form>
        <div onSubmit={handleFilterSubmit} className='flex flex-col space-y-2 md:space-y-2'>
            ...
            <InputComponent
                ...
                displayName="Gashapon Category Description"
                value={filters.category_description}
                placeholder="Enter Gashapon Category Description"
                onChange={(e) => handleFilter(e, "category_description")}
            />
        </div>
...
export default GashaponCategoriesFilter