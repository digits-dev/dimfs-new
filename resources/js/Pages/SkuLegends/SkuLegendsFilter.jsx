    ...
    <form>
        <div onSubmit={handleFilterSubmit} className='flex flex-col space-y-2 md:space-y-2'>
            ...
            <InputComponent
                ...
                value={filters.sku_legend_description}
                placeholder="Enter SKU Legend Description"
                displayName="SKU Legend Description"
                onChange={(e) => handleFilter(e, "sku_legend_description")}
            />
        </div>
...
export default SkuLegendsFilter