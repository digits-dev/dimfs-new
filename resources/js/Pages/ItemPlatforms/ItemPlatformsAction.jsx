...
const ItemPlatformsAction = ({ action, onClose, updateData }) => {
    ...
    const handleFormSubmit = (e) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                if (action == "Add") {
                    post("item_platforms/create", {
                        onSuccess: (data) => {
                            const { message, type } = data.props.auth.sessions;
                            handleToast(message, type);
                            router.reload({ only: ["item_platforms"] });
                            reset();
                            onClose();
                        },
                        onError: (error) => {},
...
export default ItemPlatformsAction;
