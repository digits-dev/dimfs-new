            ...
            <ContentPanel>
                <TopPanel>
                    <div className="inline-flex gap-1">
                        ...
                        <Export path="/admin_colors/export" page_title={page_title}/>
                    </div>
                    <div className="flex">
                        <CustomFilter>
                ...
                <TableContainer data={admin_colors?.data}>
                    <Thead>
                        <Row>
                            <TableHeader
                                sortable={false}
                    ...
                    <Tbody data={admin_colors?.data}>
                        {admin_colors &&
                            admin_colors?.data.map((item, index) => (
                                <Row key={item.id}>
                                    <RowData center>
                ...
                <Pagination extendClass={theme} paginate={admin_colors} />
            </ContentPanel>
            <Modal
                theme={theme}
                show={isModalOpen}
