...
const EcommMarginMatricesAction = ({action, onClose, updateData, all_active_brands, all_brands, all_active_vendor_types, all_vendor_types}) => {
    ...
    const handleFormSubmit = (e) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                if (action == 'Add'){
                    post('ecomm_margin_matrices/create', {
                        onSuccess: (data) => {
                            const { message, type } = data.props.auth.sessions;
                            handleToast(message, type);
                            router.reload({ only: ["ecomm_margin_matrices"] });
                            reset();
                            onClose();
                        },
                        onError: (error) => {
                    ...
                    post('ecomm_margin_matrices/update', {
                        onSuccess: (data) => {
                            const { message, type } = data.props.auth.sessions;
                            handleToast(message, type);
                            router.reload({ only: ["ecomm_margin_matrices"] });
...
export default EcommMarginMatricesAction