    ...
    <form>
        <div onSubmit={handleFilterSubmit} className='flex flex-col space-y-2 md:space-y-2'>
            ...
            <InputComponent
                ...
                value={filters.brand_marketing_description}
                placeholder="Enter Brand Marketing Description"
                onChange={(e) => handleFilter(e, "brand_marketing_description")}
            />
        </div>
...
export default BrandMarketingsFilter