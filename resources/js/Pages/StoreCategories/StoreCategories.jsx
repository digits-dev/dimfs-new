            ...
            <ContentPanel>
                <TopPanel>
                    <div className="inline-flex gap-1">
                        ...
                        <Export path="/store_categories/export" page_title={page_title}/>
                    </div>
                    <div className="flex">
                        <CustomFilter>
                            <StoreCategoriesFilter all_sub_classifications={all_sub_classifications}/>
                        </CustomFilter>
                        <TableSearch queryParams={queryParams} />
                    </div>
                </TopPanel>
                <TableContainer data={store_categories?.data}>
                    <Thead>
                        <Row>
                            <TableHeader
                                sortable={false}
                    ...
                    <Tbody data={store_categories?.data}>
                        {store_categories &&
                            store_categories?.data.map((item, index) => (
                                <Row key={item.id}>
                                    <RowData center>
                                        <RowAction
                                            type="button"
                ...
                <Pagination extendClass={theme} paginate={store_categories} />
            </ContentPanel>
            <Modal
                theme={theme}
                show={isModalOpen}
