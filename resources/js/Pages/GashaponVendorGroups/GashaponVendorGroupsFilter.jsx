...
const GashaponVendorGroupsFilter = () => {
    ...
    <form>
        <div onSubmit={handleFilterSubmit} className='flex flex-col space-y-2 md:space-y-2'>
            ...
            <InputComponent
                ...
                displayName="Vendor Group Description"
                value={filters.vendor_group_description}
                placeholder="Enter Vendor Group Description"
                onChange={(e) => handleFilter(e, "vendor_group_description")}
            />
        </div>
...
export default GashaponVendorGroupsFilter