...
import VendorTypesFilter from "./VendorTypesFilter";
    ...
    return (
        <>
            ...
            <ContentPanel>
                ...
                <TableContainer data={vendor_types?.data}>
                    <Thead>
                        <Row>
                            <TableHeader
                                sortable={false}
                    ...
                    <Tbody data={vendor_types?.data}>
                        {vendor_types &&
                            vendor_types?.data.map((item, index) => (
                                <Row key={item.id}>
                                    <RowData center>
                                        <RowAction
                                            type="button"
                ...
                <Pagination extendClass={theme} paginate={vendor_types} />
            </ContentPanel>
            <Modal
                theme={theme}
                show={isModalOpen}
