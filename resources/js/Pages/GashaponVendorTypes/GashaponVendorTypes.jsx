...
import GashaponVendorTypesFilter from "./GashaponVendorTypesFilter";
        ...
        <>
            ...
            <TopPanel>
                    <div className="inline-flex gap-1">
                        ...
                        <Export path="/gashapon_vendor_types/export" page_title={page_title}/>
                    </div>
                    <div className='flex'>
                        <CustomFilter>
                            <GashaponVendorTypesFilter/>
                        </CustomFilter>
