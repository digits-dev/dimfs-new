    ...
    <form>
        <div onSubmit={handleFilterSubmit} className='flex flex-col space-y-2 md:space-y-2'>
            ...
            <InputComponent
                ...
                displayName="Gashapon Incoterm Description"
                value={filters.incoterm_description}
                placeholder="Enter Gashapon Incoterm Description"
                onChange={(e) => handleFilter(e, "incoterm_description")}
            />
        </div>
...
export default GashaponIncotermsFilter