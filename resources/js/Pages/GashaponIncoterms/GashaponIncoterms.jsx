    ...
    const handleExport = (e) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                try {
                    window.location.href = '/gashapon_incoterms/export' + window.location.search;
                } catch (error) {
                    {
                        handleToast &&
                            handleToast(
        ...
        <>
            ...
            <TopPanel>
                    <div className="inline-flex gap-1">
                        ...
                        > 
                          <i className="fa-solid fa-plus mr-1"></i>  Add Gashapon Incoterm
                        </Button>
                        <Button
                            extendClass={(['bg-skin-white'].includes(theme) ? primayActiveColor : theme)+" py-[5px] px-[10px]"}
                            type="button"
                ...
                <TableContainer data={gashapon_incoterms?.data}>
                   <Thead>
                        <Row>
                            <TableHeader
                                sortable={false}
                    ...
                    <Tbody data={gashapon_incoterms?.data}>
                        {gashapon_incoterms &&
                            gashapon_incoterms?.data.map((item, index) => (
                                <Row key={item.id}>
                                    <RowData center>
                                        <RowAction
                                            type="button"
                ...
                <Pagination extendClass={theme} paginate={gashapon_incoterms} />
            </ContentPanel>
            <Modal
                theme={theme}
                show={isModalOpen}
                onClose={handleModalClick}
                title={action == 'Add' ? "Add Gashapon Incoterm" : action == 'Update' ? 'Update Gashapon Incoterm' : 'Gashapon Incoterm Information'}
                width="xl"
                fontColor={textColorActive}
                btnIcon='fa fa-edit'
            >
                <GashaponIncotermsAction onClose={handleModalClick} action={action} updateData={updateData}/>
            </Modal>
...
export default GashaponIncoterms;
