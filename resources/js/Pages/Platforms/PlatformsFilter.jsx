    ...
    <form>
        <div onSubmit={handleFilterSubmit} className='flex flex-col space-y-2 md:space-y-2'>
            ...
            <InputComponent
                ...
                value={filters.platform_description}
                placeholder="Enter Platform Description"
                onChange={(e) => handleFilter(e, "platform_description")}
            />
            <InputComponent
                name="platform_column"
                value={filters.platform_column}
                placeholder="Enter Platform Column"
                onChange={(e) => handleFilter(e, "platform_column")}
            />
        </div>
