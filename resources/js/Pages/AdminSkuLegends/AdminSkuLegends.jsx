    ...
    return (
        <>
            ...
            <ContentPanel>
                <TopPanel>
                    <div className="inline-flex gap-1">
                        ...
                        {auth.access.isCreate &&
                            ...
                            >
                                <i className="fa-solid fa-plus mr-1"></i> Add SKU Legend
                            </Button>
                        }
                        <Export path="/admin_sku_legends/export" page_title={page_title}/>
                    </div>
                    <div className="flex">
                        <CustomFilter>
                ...
                <TableContainer data={admin_sku_legends?.data}>
                    <Thead>
                        <Row>
                            <TableHeader
                                sortable={false}
                    ...
                    <Tbody data={admin_sku_legends?.data}>
                        {admin_sku_legends &&
                            admin_sku_legends?.data.map((item, index) => (
                                <Row key={item.id}>
                                    <RowData center>
                                        {auth.access.isUpdate &&
                                            <RowAction
                                                ...
                                                onClick={() => {
                                                    ...
                                                    setUpdateData({
                                                        id: item.id,
                                                        sku_legend_description: item.sku_legend_description,   
                                                        status: item.status,
                                                    });
                                                }}
                                            />
                ...
                <Pagination extendClass={theme} paginate={admin_sku_legends} />
            </ContentPanel>
            <Modal
                theme={theme}
                show={isModalOpen}
...
export default AdminSkuLegends;
