    ...
    <form>
        <div onSubmit={handleFilterSubmit} className='flex flex-col space-y-2 md:space-y-2'>
            ...
            <InputComponent
                ...
                value={filters.identifier_column}
                placeholder="Enter Identifier Column"
                onChange={(e) => handleFilter(e, "identifier_column")}
            />
            <InputComponent
                name="identifier_description"
                value={filters.identifier_description}
                placeholder="Enter Identifier Description"
                onChange={(e) => handleFilter(e, "identifier_description")}
            />
        </div>
