...
const Identifiers = ({ tableName, identifiers, queryParams }) => {
    ...
    return (
        <>
            ...
            <ContentPanel>
                ...
                <TableContainer data={identifiers?.data}>
                    <Thead>
                        <Row>
                            <TableHeader
                                sortable={false}
                    ...
                    <Tbody data={identifiers?.data}>
                        {identifiers &&
                            identifiers?.data.map((item, index) => (
                                <Row key={item.id}>
                                    <RowData center>
                                        <RowAction
                                            type="button"
                ...
                <Pagination extendClass={theme} paginate={identifiers} />
            </ContentPanel>
            <Modal
                theme={theme}
                show={isModalOpen}
