...
import RmaClassificationsFilter from "./RmaClassificationsFilter";
        ...
        <>
            ...
            <TopPanel>
                    <div className="inline-flex gap-1">
                        ...
                        <Export path="/rma_classifications/export" page_title={page_title}/>
                    </div>
                    <div className='flex'>
                        <CustomFilter>
                            <RmaClassificationsFilter all_rma_categories={all_rma_categories}/>
                        </CustomFilter>
                        <TableSearch queryParams={queryParams} />
                    </div>
                </TopPanel>
                <TableContainer data={rma_classifications?.data}>
                   <Thead>
                        <Row>
                            <TableHeader
                                sortable={false}
                    ...
                    <Tbody data={rma_classifications?.data}>
                        {rma_classifications &&
                            rma_classifications?.data.map((item, index) => (
                                <Row key={item.id}>
                                    <RowData center>
                                        <RowAction
                                            type="button"
                                            ...
                                            onClick={()=>{handleModalClick(); setAction('Update'); 
                                                setUpdateData({
                                                    id: item.id,
                                                    rma_categories_id: item.rma_categories_id,
                                                    rma_category_name: item.get_rma_category?.category_description,
                ...
                <Pagination extendClass={theme} paginate={rma_classifications} />
            </ContentPanel>
            <Modal
                theme={theme}
                show={isModalOpen}
                ...
                btnIcon='fa fa-edit'
            >
                <RmaClassificationsAction onClose={handleModalClick} action={action} updateData={updateData} all_active_rma_categories={all_active_rma_categories} all_rma_categories={all_rma_categories}/>
            </Modal>
...
export default RmaClassifications;
