...
import { Check, Download, Info, ShoppingCart, Upload, X } from "lucide-react";
import useThemeStyles from "../../../Hooks/useThemeStyles";
import Modalv2 from "../../../Components/Modal/Modalv2";

const ItemMasterEcomDetailsImport = ({page_title}) => {
        ...
        <>
            ...
            <div>
                <div className='flex space-x-3 items-center'>
                    ...
                    <span className={`font-bold text-sm md:text-lg ${theme === 'bg-skin-black' ? ' text-white' : 'text-black/90'}`}>ECOM Details Bulk Import</span>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-3 mt-3">
                    <div className="border rounded-lg">
                        ...
                        <div className="p-4">
                            ...
                            <a href="/item_masters/ecom_details_template" 
...
export default ItemMasterEcomDetailsImport;
