...
const ItemMasterSkuStatusImport = ({page_title}) => {
        ...
        <>
            ...
            <div>
                <div className='flex space-x-3 items-center'>
                    ...
                    <span className={`font-bold text-sm md:text-lg ${theme === 'bg-skin-black' ? ' text-white' : 'text-black/90'}`}>SKU Status/Segmentation Bulk Import</span>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-3 mt-3 select-none">
                    <div className="p-4 border-l-4 border-l-green-500 border rounded-lg">
                        <div className="flex gap-3">
                            ...
                            <div>
                            <p className={`${pageTitle} font-semibold text-sm`}>Validation of Digits Code and SKU Status</p>
                            <p className={`${pageSubTitle} text-muted-foreground text-xs`}>
                                System will not accept wrong Digits Code or SKU Status
                            </p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="grid md:grid-cols-2 gap-3 mt-3">
                    <div className="border rounded-lg">
                        ...
                        <div className="p-4">
                            ...
                            <a href="/item_masters/sku_status_template" 
...
export default ItemMasterSkuStatusImport;
