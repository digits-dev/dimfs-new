                ...
                <div className="grid md:grid-cols-2 gap-3 mt-3 select-none">
                    <div className="p-4 border-l-4 border-l-green-500 border rounded-lg">
                        <div className="flex gap-3">
                            ...
                            <div>
                            <p className="font-semibold text-sm">Data Consistency</p>
                            <p className="text-muted-foreground text-black/70 text-xs">
                    ...
                    <div className="p-4 border-l-4 border-l-green-500 border rounded-lg">
                        <div className="flex gap-3">
                            ...
                            <div>
                            <p className="font-semibold text-sm">Handling N/A Sizes</p>
                            <p className="text-muted-foreground text-black/70 text-xs">
                    ...
                    <div className="p-4 border-l-4 border-l-green-500 border rounded-lg">
                        <div className="flex gap-3">
                            ...
                            <div>
                            <p className="font-semibold text-sm">Default Codes</p>
                            <p className="text-muted-foreground text-black/70 text-xs">Enter "0" for serial code, IMEI code1, and IMEI code2</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="p-4 border-l-4 border-l-green-500 border rounded-lg">
                        <div className="flex gap-3">
                            ...
                            <div>
                            <p className="font-semibold text-sm">File Format Requirement</p>
                            <p className="text-muted-foreground text-black/70 text-xs">
                                Use <span variant="outline" className="bg-gray-200 text-black font-medium px-1.5 rounded-full w-fit">CSV</span> file format for uploads
                            </p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="grid md:grid-cols-2 gap-3 mt-3">
                    <div className="border rounded-lg">
                        ...
                        <div className="p-4">
                            ...
                            <p className="text-gray-500 mt-2 text-xs mb-4">Use our pre-formatted template to ensure your data is structured correctly for import.</p>
                            <a href="/gashapon_item_masters/gashapon_template" 
                                className={`${theme} inline-flex items-center justify-center gap-2 rounded-md text-sm font-medium mt-2 px-4 py-2 w-full  text-white`}>
                                <Download className="h-5 w-5" />
                                Download Template
                            </a>
                        </div>
                    ...
                    <div className="border rounded-lg">
                        ...
                        <div className="py-2 px-6">
                            <p className="text-xs mt-2 font-semibold">Upload your completed CSV file</p>
                            ...
                            {!selectedFile ? (
                                  ...
                                  >
                                      ...
                                      <div className="flex flex-col items-center gap-2">
                                        ...
                                        <p className="font-sm text-gray-700">Drag and drop your CSV file here</p>
