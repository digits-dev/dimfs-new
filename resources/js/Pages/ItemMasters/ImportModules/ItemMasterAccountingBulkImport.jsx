...
const ItemMasterAccountingBulkImport = ({page_title}) => {
  ...
  const handleSubmit = () => {
    post("/item_masters/import_item_master_accounting", {
        forceFormData: true,
        onSuccess: (data) => {
        ...
        <>
            ...
            <div>
                <div className='flex space-x-3 items-center'>
                    ...
                    <span className={`font-bold text-sm md:text-lg ${theme === 'bg-skin-black' ? ' text-white' : 'text-black/90'}`}>Item Master Bulk Import (Accounting)</span>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-3 mt-3 select-none">
                    ...
                    <div className="p-4 border-l-4 border-l-green-500 border rounded-lg">
                        <div className="flex gap-3">
                            ...
                            <div>
                            <p className={`${pageTitle} font-semibold text-sm`}>Effective Date Format</p>
                            <p className={`${pageSubTitle} text-muted-foreground text-xs`}>Effective date should follow this format "YYYY-MM-DD"</p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="grid md:grid-cols-2 gap-3 mt-3">
                    <div className="border rounded-lg">
                        ...
                        <div className="p-4">
                            ...
                            <a href="/item_masters/item_master_accounting_template" 
...
export default ItemMasterAccountingBulkImport;
