...
const ItemMasterMcbBulkImport = ({page_title}) => {
        ...
        <>
            ...
            <div>
                <div className='flex space-x-3 items-center'>
                    ...
                    <span className={`font-bold text-sm md:text-lg ${theme === 'bg-skin-black' ? ' text-white' : 'text-black/90'}`}>Item Master Bulk Import (MCB)</span>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-3 mt-3 select-none">
                    <div className="p-4 border-l-4 border-l-green-500 border rounded-lg">
                        <div className="flex gap-3">
                            ...
                            <div>
                            <p className={`${pageTitle} font-semibold text-sm`}>Validation of Digits Code</p>
                            <p className={`${pageSubTitle} text-muted-foreground text-xs`}>
                                System will not accept wrong Digits Code
                            </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="p-4 border-l-4 border-l-green-500 border rounded-lg">
                        <div className="flex gap-3">
                            ...
                            <div>
                            <p className={`${pageTitle} font-semibold text-sm`}>Conditional Blank Field Acceptance</p>
                            <p className={`${pageSubTitle} text-muted-foreground text-xs`}>
                    ...
                    <div className="p-4 border-l-4 border-l-green-500 border rounded-lg">
                        <div className="flex gap-3">
                            ...
                            <div>
                            <p className={`${pageTitle} font-semibold text-sm`}>Dependency Requirement for Updates</p>
                            <p className={`${pageSubTitle} text-muted-foreground text-xs`}>If one of the following needs to be updated (e.g., class, subclass, margin category), then CATEGORY, CLASS, SUBCLASS, and MARGIN CATEGORY cannot be null/blank</p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="p-4 border-l-4 border-l-green-500 mt-3 border rounded-lg">
                    <div className="flex gap-3">
                        <div className="bg-green-100 rounded-full p-1 h-6 w-6 flex items-center justify-center flex-shrink-0">
                        <Check className="h-4 w-4 text-green-600" />
                        </div>
                ...
                <div className="grid md:grid-cols-2 gap-3 mt-3">
                    <div className="border rounded-lg">
                        ...
                        <div className="p-4">
                            ...
                            <a href="/item_masters/item_master_mcb_template" 
...
export default ItemMasterMcbBulkImport;
