            ...
            <ContentPanel>
                <TopPanel>
                    <div className="inline-flex gap-1">
                        ...
                        <Export path="/admin_vendors/export" page_title={page_title}/>
                    </div>
                    <div className="flex">
                        <CustomFilter>
                ...
                <TableContainer data={admin_vendors?.data}>
                    <Thead>
                        <Row>
                            <TableHeader
                                sortable={false}
                    ...
                    <Tbody data={admin_vendors?.data}>
                        {admin_vendors &&
                            admin_vendors?.data.map((item, index) => (
                                <Row key={item.id}>
                                    <RowData center>
                                        {auth.access.isUpdate &&
                                            <RowAction
                                                ...
                                                onClick={() => {
                                                    ...
                                                    setUpdateData({
                                                        id: item.id,
                                                        admin_brands_id: item.admin_brands_id,
                ...
                <Pagination extendClass={theme} paginate={admin_vendors} />
            </ContentPanel>
            <Modal
                theme={theme}
                show={isModalOpen}
