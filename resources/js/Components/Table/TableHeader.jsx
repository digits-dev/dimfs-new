...
const TableHeader = ({
  ...
  return (
		<th
			...
			className={`${theme === 'bg-skin-black' ? theme+' text-gray-400' : 'bg-custom-gray text-customTextGray'} border-r-[1px] border-secondary last:border-r-0 font-poppins text-[13px]  ${widthClass} ${stickyClass}`}>
