...
const Buttonv2 = ({
  ...
  return (
    <>
        {type == 'button' ? 
            <div className={`${color || theme} w-fit items-center select-none ${textColor} space-x-2 flex justify-center px-3 py-2 md:px-3.5 md:py-2.5 rounded-md hover:opacity-70 cursor-pointer ${disabled ? theme + '/70 !cursor-not-allowed' : ''} ${addClass}`} onClick={disabled ? undefined : onClick}>
